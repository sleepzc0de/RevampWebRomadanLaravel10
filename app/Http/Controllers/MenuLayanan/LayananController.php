...
class LayananController extends Controller
{
            ...
            return datatables()->of($query)
                ...
                ->addColumn('opsi', function ($query) {
                    return view('components.datatable-actions', [
                        ...
                        'destroy' => route('layanan.destroy', encrypt($query->id)),
                    ])->render();
                })
    ...
    public function store(Request $request)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'image' => 'required|image|mimes:jpeg,png,jpg|max:20480', // Increased from 10MB to 20MB
                'additional_images.*' => 'nullable|image|mimes:jpeg,png,jpg|max:20480', // For multiple images
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'image' => 'nullable|image|mimes:jpeg,png,jpg|max:20480', // Increased to 20MB
                'additional_images.*' => 'nullable|image|mimes:jpeg,png,jpg|max:20480', // For multiple images
            ...
            return redirect()->route('layanan.index')->with(['failed' => 'Layanan Gagal Di Update!']);
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('layanan.index')->with(['failed' => 'Layanan Yang Dihapus Tidak Ada !']);
        }
    }
