							...
							<div class="card-body">
								...
								<div class="mb-4">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<input maxlength="255" value="{{ old('nama_kategori') ?? $kategori->nama_kategori }}" type="text" name="nama_kategori" class="form-control @error('nama_kategori') is-invalid @enderror" required placeholder="Masukkan Nama Kategori">
