							...
							<div class="card-body">
								...
								<div class="mb-4">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<input maxlength="255" value="{{ old('nama_status') ?? $status->nama_status }}" type="text" name="nama_status" class="form-control @error('nama_status') is-invalid @enderror" required placeholder="Masukkan Nama status">
