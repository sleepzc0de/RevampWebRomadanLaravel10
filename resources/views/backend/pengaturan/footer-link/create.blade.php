...
<div class="card">
    ...
    <form class="form-validate-jquery" action="{{route('footer-link.store')}}" method="post" autocomplete="off">
        @csrf
        <div class="card-body">
            <div class="mb-4">
                <!-- Label -->
                <div class="row mb-3">
                    ...
                    <div class="col-lg-10">
                        <input maxlength="100" value="{{ old('label') }}" type="text" name="label" class="form-control @error('label') is-invalid @enderror" required placeholder="Misal: Layanan">
                        @error('label')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-10">
                        <input maxlength="500" value="{{ old('url') }}" type="text" name="url" class="form-control @error('url') is-invalid @enderror" required placeholder="/layanan atau https://contoh.com">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-10">
                        <input value="{{ old('sort_order', 0) }}" type="number" min="0" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror">
                        <small class="text-muted">Semakin kecil angkanya, semakin awal tautan ditampilkan.</small>
                        @error('sort_order')
                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="card-footer d-flex justify-content-end">
            ...
            <button type="reset" class="btn btn-light ms-3">Reset</button>
