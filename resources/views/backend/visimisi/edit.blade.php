...
<!-- Form validation -->
					<div class="card">
						...
						<form class="form-validate-jquery" action="{{route('visi-misi.update', encrypt($visimisi->id))}}" method="post" enctype="multipart/form-data" autocomplete="off">
							@csrf
                            @method('PUT')
							<div class="card-body">
								...
								<div class="mb-4">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<input value="{{ old('judul') ?? $visimisi->judul }}" type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" required placeholder="Masukkan Judul Artikel">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<textarea name="visi" class="form-control @error('visi') is-invalid @enderror" required placeholder="Visi" id="ckeditor_classic_empty_visi">{{ old('visi') ?? $visimisi->visi }}</textarea>
										</div>
									</div>
									<!-- /VISI -->
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<textarea name="misi" class="form-control @error('misi') is-invalid @enderror" required placeholder="Misi" id="ckeditor_classic_empty_misi">{{ old('misi') ?? $visimisi->misi }}</textarea>
										</div>
									</div>
									<!-- /MISI -->
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											...
											<div class="mt-3">
												<img src="{{asset('storage/romadan_gambar_web/'.$visimisi->image)}}" alt="" width="300px">
											</div>
											@error('image')
											<div class="alert alert-danger mt-2">
												{{ $message }}
						...
						<div class="card-footer d-flex justify-content-end">
							<a href="{{ route('visi-misi.index') }}" class="btn btn-warning"><i class="ph-caret-double-left"></i>Kembali</a>
