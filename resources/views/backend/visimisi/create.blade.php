...
<!-- Form validation -->
					<div class="card">
						...
						<form class="form-validate-jquery" action="{{route('visi-misi.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
							@csrf
							<div class="card-body">
								...
								<div class="mb-4">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<input value="{{ old('judul') }}" type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" required placeholder="Masukkan Judul Visi Misi">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<textarea name="visi" class="form-control @error('visi') is-invalid @enderror" required placeholder="Visi" id="ckeditor_classic_empty_visi">{{ old('visi') }}</textarea>
										</div>
									</div>
									<!-- /VISI -->
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<textarea name="misi" class="form-control @error('misi') is-invalid @enderror" required placeholder="Misi" id="ckeditor_classic_empty_misi">{{ old('misi') }}</textarea>
										</div>
									</div>
									<!-- /MISI -->
