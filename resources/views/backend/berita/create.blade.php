...
<!-- Form validation -->
					<div class="card">
						...
						<form class="form-validate-jquery" action="{{route('berita.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
							@csrf
							<div class="card-body">
								...
								<div class="mb-4">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<input value="{{ old('judul') }}" type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" required placeholder="Masukkan Judul Berita">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<input value="{{ old('sub_judul') }}" type="text" name="sub_judul" class="form-control @error('sub_judul') is-invalid @enderror" required placeholder="Masukkan Sub Judul Berita">
											<!-- error message untuk judul -->
												@error('sub_judul')
												<div class="alert alert-danger mt-2">
													{{ $message }}
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											{{-- <textarea rows="5" cols="5" name="isi" class="form-control @error('isi') is-invalid @enderror" required placeholder="Isi Berita">{{ old('isi') }}</textarea> --}}

											<textarea name="isi" class="form-control @error('isi') is-invalid @enderror" required placeholder="Isi Berita" id="ckeditor_classic_empty">{{ old('isi') }}</textarea>
										</div>
									</div>
									<!-- /Isi Berita Input -->
