...
const DatatableBasic = function() {
    ...
    const _componentDatatableBasic = function() {
        ...
        $('.datatable-basic').DataTable({
            ...
            {data: 'image_layanan',name:'image_layanan',orderable:false, searchable:false},
...
<!-- Basic datatable -->
					...
					<div class="card">
                        <div class="card-header text-center">
                          <h1>Layanan Romadan</h1>
                           @include('layouts.webromadan_backend.session_notif')
						</div>
                        <div class="card-header">
                          
                                    <a href="{{route('layanan.create')}}"><button type="button" class="btn btn-flat-purple btn-labeled btn-labeled-start rounded-pill">
