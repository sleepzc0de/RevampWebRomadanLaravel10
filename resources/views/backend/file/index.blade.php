...
<!-- Basic datatable -->
					...
					<div class="card">
                        <div class="card-header text-center">
                          <h1>List File Web Romadan</h1>
                           @include('layouts.webromadan_backend.session_notif')
						</div>
                        <div class="card-header">
                          
                                    <a href="{{route('file.create')}}"><button type="button" class="btn btn-flat-purple btn-labeled btn-labeled-start rounded-pill">
                                    ...
                                    <a href="{{route('file.sampah')}}"><button type="button" class="btn btn-flat-pink btn-labeled btn-labeled-start rounded-pill">
                                        <span class="btn-labeled-icon bg-pink text-white rounded-pill">
                                            <i class="ph-check-square-offset"></i>
                                        </span>
                                        Daftar File Terhapus
                                    </button></a>
