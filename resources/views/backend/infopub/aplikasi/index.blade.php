...
const DatatableBasic = function() {
    ...
    const _componentDatatableBasic = function() {
        ...
        $('.datatable-basic').DataTable({
            ...
            {data: 'judul_aplikasi',name:'judul_aplikasi'},
            {data: 'sub_judul_aplikasi',name:'sub_judul_aplikasi'},
            {data: 'link_aplikasi',name:'link_aplikasi'},
            {data: 'image_aplikasi',name:'image_aplikasi',orderable:false, searchable:false},
...
<!-- Basic datatable -->
					...
					<div class="card">
                        ...
                        <div class="card-header">
                                    ...
                                    <a href="{{route('aplikasi.create')}}"><button type="button" class="btn btn-flat-purple btn-labeled btn-labeled-start rounded-pill">
