							...
							<div class="card-body">
                                ...
                                <!-- Judul Artikel input -->
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<textarea maxlength="3000" name="isi" class="form-control @error('isi') is-invalid @enderror" required placeholder="Isikan List Informasi" id="ckeditor_classic_empty">{{ old('isi') ?? $data->isi }}</textarea>
										</div>
									</div>
									<!-- /kegiatan -->
