    ...
    const _componentDatatableBasic = function() {
        ...
        $('.datatable-basic').DataTable({
            ...
            { data:'DT_RowIndex', name:'DT_RowIndex', width:'10px',orderable:false,searchable:false},
             {data: 'nama_gambar',name:'nama_gambar'},
            {data: 'image_loggambar',name:'image_loggambar',orderable:false, searchable:false},
...
<!-- Basic datatable -->
					...
					<div class="card">
                        <div class="card-header text-center">
                          <h1>List Gambar Login Romadan</h1>
                           @include('layouts.webromadan_backend.session_notif')
						</div>
                        <div class="card-header">
                          
                                    <a href="{{route('loggambar.create')}}"><button type="button" class="btn btn-flat-purple btn-labeled btn-labeled-start rounded-pill">
