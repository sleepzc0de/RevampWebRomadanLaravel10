...
const DatatableBasic = function() {
    ...
    const _componentDatatableBasic = function() {
        ...
        $('.datatable-basic').DataTable({
            ...
            {data: 'image_artikel',name:'image_artikel',orderable:false, searchable:false},
...
<!-- Basic datatable -->
					...
					<div class="card">
                        <div class="card-header text-center">
                          <h1>List Artikel Romadan</h1>
                           @include('layouts.webromadan_backend.session_notif')
						</div>
                        <div class="card-header">
                          
                                    <a href="{{route('artikel.create')}}"><button type="button" class="btn btn-flat-purple btn-labeled btn-labeled-start rounded-pill">
                                    ...
                                    <a href="{{route('artikel.sampah')}}"><button type="button" class="btn btn-flat-pink btn-labeled btn-labeled-start rounded-pill">
                                        <span class="btn-labeled-icon bg-pink text-white rounded-pill">
                                            <i class="ph-check-square-offset"></i>
                                        </span>
                                        Daftar Artikel Terhapus
                                    </button></a>
