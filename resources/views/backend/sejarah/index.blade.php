...
const DatatableBasic = function() {
    ...
    const _componentDatatableBasic = function() {
        ...
        $('.datatable-basic').DataTable({
            ...
            {data: 'image_sejarah',name:'image_sejarah',orderable:false, searchable:false},
...
<!-- Basic datatable -->
					...
					<div class="card">
                        <div class="card-header text-center">
                          <h1>Sejarah Romadan</h1>
                           @include('layouts.webromadan_backend.session_notif')
						</div>
                        <div class="card-header">
                          
                                    <a href="{{route('sejarah.create')}}"><button type="button" class="btn btn-flat-purple btn-labeled btn-labeled-start rounded-pill">
