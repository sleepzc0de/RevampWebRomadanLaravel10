							...
							<div class="card-body">
								...
								<div class="mb-4">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<input value="{{ old('judul') ?? $sejarah->judul }}" type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" required placeholder="Masukkan Judul Artikel">
									...
									<div class="row mb-3">
										...
										<div class="col-lg-10">
											<textarea name="sejarah" class="form-control @error('sejarah') is-invalid @enderror" required placeholder="Sejarah" id="ckeditor_classic_empty_sejarah">{{ old('sejarah') ?? $sejarah->sejarah }}</textarea>
										</div>
									</div>
									<!-- /SEJARAH -->
