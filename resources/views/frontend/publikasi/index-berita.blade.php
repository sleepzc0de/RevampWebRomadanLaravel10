            ...
            <div class="col-lg-12">
                ...
                <form class="form-outline mt-5" action="{{ route('publikasi-index-berita-fe') }}" method="POST"
                    ...
                    <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                        <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="cari_berita_terkini"
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <a class="btn btn-light pilihan-kategori-menu {{ Request::routeIs('publikasi-index-berita-fe') ? 'active' : '' }}"
