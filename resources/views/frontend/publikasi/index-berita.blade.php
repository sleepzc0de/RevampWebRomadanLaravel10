...
<section class="section-welcome p-t-120 p-b-105" style="background-color: white;">
    <div class="container">
        ...
        <div class="col-lg-12">
            ...
            <form class="form-outline mt-5" id="searchForm" data-action="{{ route('publikasi-index-berita-fe') }}" method="POST" autocomplete="off">
                @csrf
                ...
                <div class="col-lg-12 text-center">
                    ...
                    @foreach ($kategori as $item)
                        <a class="btn pilihan-kategori-menu"
                            href="{{ route('berita-kategori-fe', e(strtolower($item->nama_kategori))) }}">
        ...
        <div class="col-lg-12 mt-5" id="berita-container">
            @include('frontend.publikasi.partials.berita-list', ['berita' => $berita, 'isSearch' => $isSearch, 'searchValue' => $searchValue])
        </div>
    </div>
</section>
@endsection
        ...
        if (searchForm && searchInput) {
            ...
            function performSearch() {
                ...
                .catch(error => {
                    ...
                    beritaContainer.innerHTML = '<div class="alert alert-danger">An error occurred while searching. Please try again later.</div>';
                })
                .finally(() => {
