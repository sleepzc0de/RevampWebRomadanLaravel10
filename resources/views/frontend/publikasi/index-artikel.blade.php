    ...
    <section class="section-welcome p-t-120 p-b-105" style="background-color: white;">
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <form class="form-outline mt-5" action="{{ route('publikasi-index-artikel-fe') }}" method="POST"
                    autocomplete="off">
                    @csrf
                    <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
                        <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="cari_artikel"
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <a class="btn btn-light pilihan-kategori-menu {{ Request::routeIs('publikasi-index-artikel-fe') ? 'active' : '' }}"
                            href="{{ route('publikasi-index-artikel-fe') }}">View All
                        </a>
                        @foreach ($kategori as $item)
                            <a class="btn btn-light pilihan-kategori-menu"
                                href="{{ route('artikel-kategori-fe', strip_tags(strtolower($item->nama_kategori))) }}">
            ...
            <div class="col-lg-12 mt-5">
                <div class="row">
                    {{-- Tampilkan pesan "Anda sedang mencari..." --}}
                    @if ($isSearch)
                        <div class="col-12">
                            <h3 class="m-b-2 text-center">Anda sedang mencari: "{{ $searchValue }}"</h3>
                        </div>
                    @endif
