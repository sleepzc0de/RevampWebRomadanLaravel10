            ...
            <div class="col-lg-12">
                ...
                <form class="form-outline mt-5" action="{{ route('publikasi-index-warta-fe') }}" method="POST"
                    ...
                    {{-- <div class="wrap-btn-booking flex-c-m m-t-13">
							<button type="reset" class="btn3-warta-2 flex-c-m size36 txt11 trans-0-4 mr-2">
								Clear
							</button>
							<button type="submit" class="btn3-warta flex-c-m size36 txt11 trans-0-4">
								Cari
							</button>
							<a class="btn3-warta-refresh flex-c-m size36 txt11 trans-0-4 ml-2" href="{{route('publikasi-index-berita-fe')}}">Refresh
							</a>
						</div> --}}

                    <div class="col-lg-12 text-center">
                        <a class="btn btn-light pilihan-kategori-menu" href="{{ route('publikasi-index-warta-fe') }}">View
                            All
                        </a>
