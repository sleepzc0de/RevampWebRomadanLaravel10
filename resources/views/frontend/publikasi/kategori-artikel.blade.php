    ...
    <section class="section-welcome p-t-120 p-b-105" style="background-color: white;">
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <form id="searchForm" action="{{ route('artikel-kategori-fe', ['kategori' => request()->segment(2)]) }}" method="POST">
                    @csrf
                    ...
                    <div class="col-lg-12 text-center">
                        <a class="btn pilihan-kategori-menu {{ Request::routeIs('publikasi-index-artikel-fe') ? 'active' : '' }}"
                            href="{{ route('publikasi-index-artikel-fe') }}">
                            View All
                        </a>
            ...
            <div class="col-lg-12 mt-5" id="artikel-container">
                @include('frontend.publikasi.partials.artikel-list', [
                    'artikel' => $artikel,
                    'isSearch' => $isSearch,
...
<script>
    ...
    if (searchForm && searchInput) {
        ...
        function performSearch() {
            ...
            formData.append('cari_artikel', searchInput.value);
            formData.append('current_kategori', currentCategory);
            formData.append('_token', document.querySelector('meta[name="csrf-token"]').content);

            // Use the correct URL format
            const baseUrl = `${window.location.origin}/publikasi/artikel/kategori/${currentCategory}`;
