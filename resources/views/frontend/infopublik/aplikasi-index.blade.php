...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const updateContent = async (url, params = {}) => {
        try {
            showLoading();
            ...
            document.getElementById('applicationsGrid').innerHTML = data.html;
            document.getElementById('paginationContainer').innerHTML = data.pagination;

            // Update URL without page refresh
            const newUrl = new URL(window.location);
            if (params.cari_aplikasi) {
                newUrl.searchParams.set('cari_aplikasi', params.cari_aplikasi);
            } else {
                newUrl.searchParams.delete('cari_aplikasi');
            }
    ...
    searchInput.addEventListener('input', (e) => {
        ...
        if (searchValue.length >= 3 || searchValue.length === 0) {
            searchTimeout = setTimeout(() => {
                updateContent('{{ route("informasi-publik-aplikasi-index-fe") }}', {
